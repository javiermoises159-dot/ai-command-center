...
export function defaultAgentSpecs(): AgentSpec[] {
  return [
    ...
    active({
      ...
      kind: 'worker',
      legacyAgentId: 'code',
      capabilities: ['engineering.architecture', 'engineering.build_plan', 'engineering.site'],
      outputs: ['stack recomendado', 'forma del sistema', 'fases de construcción', 'principal riesgo técnico', 'página web completa en un archivo'],
      preferredTiers: ['local_strong', 'external', 'local'],
      minModelQuality: 3,
      costClass: 'medium',
